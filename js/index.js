...
(function () {
    ...
    angular.module('suricate.home', ['suricate.service', 'marketplace.list', 'suricate.users'])
        .config([
          '$interpolateProvider',
    ...
    function HomeController($scope, GHService, NpmService) {
        GHService.getGitHubConfig('suricate-io', 'suricate').success(function (data) {
        ...
        function getContributors(){
            ...
            GHService.getGitHubContributors('suricate', 'generator-suricate', page).success(function (data) {
                if(data.length != 0){
        ...
        */
        ...
        NpmService.getNpmDownloadsLastMonth('generator-suricate').success(function (data) {
