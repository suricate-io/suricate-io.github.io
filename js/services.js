(function () {
    ...
    angular.module('suricate.service', [])
    ...
    function ModuleService($http) {
        ...
        return {
            ...
            getAllModules: function (start, size) {
                /* Get all suricate modules */
                return $http.get('https://api.npms.io/v2/search?q=keywords%3Asuricate-module%2Csuricate-blueprint&from=' + start + '&size=' + size).success(function (resp) {
                    return resp;
                });
            },
    ...
    function jhiModuleFilter () {
        return function(input) {
            return input.replace('generator-suricate-','').replace(/(?:^|[\s\-\_\.])\S/g, function(a) {
